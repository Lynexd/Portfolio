  ...
  return (
    <div className='mt-6 container mx-auto pb-8 w-11/12 sm:pb-10 sm:w-9/12 md:w-7/12'>
      <div className='space-y-2 my-5'>
        <h3 className='font-semibold text-3xl text-zinc-200'> Teknolojiler </h3>
        <p className='text-zinc-400'> Yazılımda Kullandığım Tüm Diller ve Teknolojiler. </p>
        <br />
